...
import (
	...
	"github.com/myoperator/podrestartoperator/pkg/client/clientset/versioned/scheme"
...
func (c *ApiV1alpha1Client) PodReStarters(namespace string) PodReStarterInterface {
	return newPodReStarters(c, namespace)
}
